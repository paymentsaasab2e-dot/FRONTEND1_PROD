  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        <div className={`${LMS_CARD_CLASS} flex flex-col gap-3 border-orange-100 bg-orange-50/20 sm:flex-row sm:items-center sm:justify-between`}>
          ...
          <p className="text-xs font-medium text-gray-500">Streaks and confidence derive from local session attempts.</p>
        </div>
      </section>
