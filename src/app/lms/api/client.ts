export const LMS_API_BASE = process.env.NEXT_PUBLIC_API_URL ? `${process.env.NEXT_PUBLIC_API_URL}/lms` : 'http://localhost:5000/api/lms';
...
// CV EDITOR ENDPOINTS
// ---------------------------------------------------------
export const CV_API_BASE = process.env.NEXT_PUBLIC_API_URL ? `${process.env.NEXT_PUBLIC_API_URL}/cveditor` : 'http://localhost:5000/api/cveditor';
